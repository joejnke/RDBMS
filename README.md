...
A relational data model using n-ary relation to store data 
        ...
        denoted by ![equation](http://latex.codecogs.com/gif.latex?R%3D%5Cfrac%7BTotalTemplate%7D%7BTotalVolume%7D) 

where -> A table is a relation
      -> Rows are n-tuples
